...
#ifndef _PIC32CMPL10_MCLK_COMPONENT_H_
#define _PIC32CMPL10_MCLK_COMPONENT_H_
...
#define MCLK_INTFLAG_CKRDY_Pos                _UINT8_(0)                                           /* (MCLK_INTFLAG) Clock Ready Interrupt Flag Position */
#define MCLK_INTFLAG_CKRDY_Msk                (_UINT8_(0x1) << MCLK_INTFLAG_CKRDY_Pos)             /* (MCLK_INTFLAG) Clock Ready Interrupt Flag Mask */
...
/* -------- MCLK_AHBMASK : (MCLK Offset: 0x10) (R/W 32) AHB Bridge Mask -------- */
#define MCLK_AHBMASK_RESETVALUE               _UINT32_(0x3FF)                                      /*  (MCLK_AHBMASK) AHB Bridge Mask  Reset Value */
...
/* -------- MCLK_APBAMASK : (MCLK Offset: 0x14) (R/W 32) APB Bridge A Mask -------- */
#define MCLK_APBAMASK_RESETVALUE              _UINT32_(0x7FF)                                      /*  (MCLK_APBAMASK) APB Bridge A Mask  Reset Value */
...
#define MCLK_APBBMASK_DMAC_Pos                _UINT32_(3)                                          /* (MCLK_APBBMASK) DMAC APB Clock Enable Position */
#define MCLK_APBBMASK_DMAC_Msk                (_UINT32_(0x1) << MCLK_APBBMASK_DMAC_Pos)            /* (MCLK_APBBMASK) DMAC APB Clock Enable Mask */
#define MCLK_APBBMASK_DMAC(value)             (MCLK_APBBMASK_DMAC_Msk & (_UINT32_(value) << MCLK_APBBMASK_DMAC_Pos)) /* Assignment of value for DMAC in the MCLK_APBBMASK register */
#define MCLK_APBBMASK_MTB_Pos                 _UINT32_(4)                                          /* (MCLK_APBBMASK) MTB APB Clock Enable Position */
#define MCLK_APBBMASK_MTB_Msk                 (_UINT32_(0x1) << MCLK_APBBMASK_MTB_Pos)             /* (MCLK_APBBMASK) MTB APB Clock Enable Mask */
#define MCLK_APBBMASK_MTB(value)              (MCLK_APBBMASK_MTB_Msk & (_UINT32_(value) << MCLK_APBBMASK_MTB_Pos)) /* Assignment of value for MTB in the MCLK_APBBMASK register */
...
#define MCLK_APBBMASK_Msk                     _UINT32_(0x0000003F)                                 /* (MCLK_APBBMASK) Register Mask  */


/* -------- MCLK_APBCMASK : (MCLK Offset: 0x1C) (R/W 32) APB Bridge C Mask -------- */
#define MCLK_APBCMASK_RESETVALUE              _UINT32_(0x800)                                      /*  (MCLK_APBCMASK) APB Bridge C Mask  Reset Value */
...
#define MCLK_APBCMASK_TC0_Pos                 _UINT32_(3)                                          /* (MCLK_APBCMASK) TC0 APB Clock Enable Position */
...
#define MCLK_APBCMASK_TC1_Pos                 _UINT32_(4)                                          /* (MCLK_APBCMASK) TC1 APB Clock Enable Position */
...
#define MCLK_APBCMASK_TC2_Pos                 _UINT32_(5)                                          /* (MCLK_APBCMASK) TC2 APB Clock Enable Position */
...
#define MCLK_APBCMASK_TCC0_Pos                _UINT32_(6)                                          /* (MCLK_APBCMASK) TCC0 APB Clock Enable Position */
...
#define MCLK_APBCMASK_ADC0_Pos                _UINT32_(7)                                          /* (MCLK_APBCMASK) ADC0 APB Clock Enable Position */
...
#define MCLK_APBCMASK_CCL_Pos                 _UINT32_(9)                                          /* (MCLK_APBCMASK) CCL APB Clock Enable Position */
...
#define MCLK_APBCMASK_PTC_Pos                 _UINT32_(10)                                         /* (MCLK_APBCMASK) PTC APB Clock Enable Position */
...
#define MCLK_APBCMASK_SYSCTRL_Pos             _UINT32_(11)                                         /* (MCLK_APBCMASK) SYSCTRL APB Clock Enable Position */
#define MCLK_APBCMASK_SYSCTRL_Msk             (_UINT32_(0x1) << MCLK_APBCMASK_SYSCTRL_Pos)         /* (MCLK_APBCMASK) SYSCTRL APB Clock Enable Mask */
#define MCLK_APBCMASK_SYSCTRL(value)          (MCLK_APBCMASK_SYSCTRL_Msk & (_UINT32_(value) << MCLK_APBCMASK_SYSCTRL_Pos)) /* Assignment of value for SYSCTRL in the MCLK_APBCMASK register */
#define MCLK_APBCMASK_Msk                     _UINT32_(0x00000FFF)                                 /* (MCLK_APBCMASK) Register Mask  */

#define MCLK_APBCMASK_SERCOM_Pos              _UINT32_(1)                                          /* (MCLK_APBCMASK Position) SERCOMx APB Clock Enable */
#define MCLK_APBCMASK_SERCOM_Msk              (_UINT32_(0x3) << MCLK_APBCMASK_SERCOM_Pos)          /* (MCLK_APBCMASK Mask) SERCOM */
#define MCLK_APBCMASK_SERCOM(value)           (MCLK_APBCMASK_SERCOM_Msk & (_UINT32_(value) << MCLK_APBCMASK_SERCOM_Pos)) 
#define MCLK_APBCMASK_TC_Pos                  _UINT32_(3)                                          /* (MCLK_APBCMASK Position) TCx APB Clock Enable */
...
#define MCLK_APBCMASK_TCC_Pos                 _UINT32_(6)                                          /* (MCLK_APBCMASK Position) TCCx APB Clock Enable */
#define MCLK_APBCMASK_TCC_Msk                 (_UINT32_(0x1) << MCLK_APBCMASK_TCC_Pos)             /* (MCLK_APBCMASK Mask) TCC */
#define MCLK_APBCMASK_TCC(value)              (MCLK_APBCMASK_TCC_Msk & (_UINT32_(value) << MCLK_APBCMASK_TCC_Pos)) 
#define MCLK_APBCMASK_ADC_Pos                 _UINT32_(7)                                          /* (MCLK_APBCMASK Position) ADCx APB Clock Enable */
...
#define MCLK_AHBMASK_REG_OFST          _UINT32_(0x10)      /* (MCLK_AHBMASK) AHB Bridge Mask Offset */
#define MCLK_APBAMASK_REG_OFST         _UINT32_(0x14)      /* (MCLK_APBAMASK) APB Bridge A Mask Offset */
#define MCLK_APBBMASK_REG_OFST         _UINT32_(0x18)      /* (MCLK_APBBMASK) APB Bridge B Mask Offset */
#define MCLK_APBCMASK_REG_OFST         _UINT32_(0x1C)      /* (MCLK_APBCMASK) APB Bridge C Mask Offset */
...
{  /* Main Clock */
  ...
  __IO  uint32_t                       MCLK_AHBMASK;       /* Offset: 0x10 (R/W  32) AHB Bridge Mask */
  __IO  uint32_t                       MCLK_APBAMASK;      /* Offset: 0x14 (R/W  32) APB Bridge A Mask */
  __IO  uint32_t                       MCLK_APBBMASK;      /* Offset: 0x18 (R/W  32) APB Bridge B Mask */
  __IO  uint32_t                       MCLK_APBCMASK;      /* Offset: 0x1C (R/W  32) APB Bridge C Mask */
} mclk_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CMPL10_MCLK_COMPONENT_H_ */
