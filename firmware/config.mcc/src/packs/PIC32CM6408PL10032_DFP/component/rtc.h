...
#ifndef _PIC32CMPL10_RTC_COMPONENT_H_
#define _PIC32CMPL10_RTC_COMPONENT_H_
...
#define RTC_MODE0_CTRLA_COUNTSYNC_Pos         _UINT16_(15)                                         /* (RTC_MODE0_CTRLA) COUNT Read Resynchronization Enable Position */
#define RTC_MODE0_CTRLA_COUNTSYNC_Msk         (_UINT16_(0x1) << RTC_MODE0_CTRLA_COUNTSYNC_Pos)     /* (RTC_MODE0_CTRLA) COUNT Read Resynchronization Enable Mask */
...
#define RTC_MODE1_CTRLA_COUNTSYNC_Pos         _UINT16_(15)                                         /* (RTC_MODE1_CTRLA) COUNT Read Resynchronization Enable Position */
#define RTC_MODE1_CTRLA_COUNTSYNC_Msk         (_UINT16_(0x1) << RTC_MODE1_CTRLA_COUNTSYNC_Pos)     /* (RTC_MODE1_CTRLA) COUNT Read Resynchronization Enable Mask */
...
#define   RTC_MODE2_CTRLA_CLKREP_CLK24H_Val   _UINT16_(0x0)                                        /* (RTC_MODE2_CTRLA) 24 hour clock format  */
#define   RTC_MODE2_CTRLA_CLKREP_CLK12H_Val   _UINT16_(0x1)                                        /* (RTC_MODE2_CTRLA) 12 hour (AM/PM) clock format  */
#define RTC_MODE2_CTRLA_CLKREP_CLK24H         (RTC_MODE2_CTRLA_CLKREP_CLK24H_Val << RTC_MODE2_CTRLA_CLKREP_Pos) /* (RTC_MODE2_CTRLA) 24 hour clock format Position */
#define RTC_MODE2_CTRLA_CLKREP_CLK12H         (RTC_MODE2_CTRLA_CLKREP_CLK12H_Val << RTC_MODE2_CTRLA_CLKREP_Pos) /* (RTC_MODE2_CTRLA) 12 hour (AM/PM) clock format Position */
...
#define RTC_MODE2_CTRLA_CLOCKSYNC_Pos         _UINT16_(15)                                         /* (RTC_MODE2_CTRLA) CLOCK Read Resynchronization Enable Position */
#define RTC_MODE2_CTRLA_CLOCKSYNC_Msk         (_UINT16_(0x1) << RTC_MODE2_CTRLA_CLOCKSYNC_Pos)     /* (RTC_MODE2_CTRLA) CLOCK Read Resynchronization Enable Mask */
...
#define RTC_MODE2_INTENSET_PER0_Pos           _UINT16_(0)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 0 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER0_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER0_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 0 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER1_Pos           _UINT16_(1)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 1 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER1_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER1_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 1 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER2_Pos           _UINT16_(2)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 2 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER2_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER2_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 2 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER3_Pos           _UINT16_(3)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 3 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER3_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER3_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 3 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER4_Pos           _UINT16_(4)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 4 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER4_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER4_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 4 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER5_Pos           _UINT16_(5)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 5 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER5_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER5_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 5 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER6_Pos           _UINT16_(6)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 6 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER6_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER6_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 6 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER7_Pos           _UINT16_(7)                                          /* (RTC_MODE2_INTENSET) Periodic Interval 7 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_PER7_Msk           (_UINT16_(0x1) << RTC_MODE2_INTENSET_PER7_Pos)       /* (RTC_MODE2_INTENSET) Periodic Interval 7 Interrupt Enable Mask */
...
#define RTC_MODE2_INTENSET_PER_Pos            _UINT16_(0)                                          /* (RTC_MODE2_INTENSET Position) Periodic Interval x Interrupt Enable */
...
#define RTC_DBGCTRL_DBGRUN_Pos                _UINT8_(0)                                           /* (RTC_DBGCTRL) Debug Run Position */
#define RTC_DBGCTRL_DBGRUN_Msk                (_UINT8_(0x1) << RTC_DBGCTRL_DBGRUN_Pos)             /* (RTC_DBGCTRL) Debug Run Mask */
...
/* -------- RTC_MODE0_SYNCBUSY : (RTC Offset: 0x10) ( R/ 32) MODE0 Synchronization Busy -------- */
#define RTC_MODE0_SYNCBUSY_RESETVALUE         _UINT32_(0x00)                                       /*  (RTC_MODE0_SYNCBUSY) MODE0 Synchronization Busy  Reset Value */

#define RTC_MODE0_SYNCBUSY_SWRST_Pos          _UINT32_(0)                                          /* (RTC_MODE0_SYNCBUSY) Software Reset Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_SWRST_Msk          (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_SWRST_Pos)      /* (RTC_MODE0_SYNCBUSY) Software Reset Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_ENABLE_Pos         _UINT32_(1)                                          /* (RTC_MODE0_SYNCBUSY) Enable Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_ENABLE_Msk         (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_ENABLE_Pos)     /* (RTC_MODE0_SYNCBUSY) Enable Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_FREQCORR_Pos       _UINT32_(2)                                          /* (RTC_MODE0_SYNCBUSY) Frequency Correction Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_FREQCORR_Msk       (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_FREQCORR_Pos)   /* (RTC_MODE0_SYNCBUSY) Frequency Correction Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_COUNT_Pos          _UINT32_(3)                                          /* (RTC_MODE0_SYNCBUSY) Counter Value Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_COUNT_Msk          (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_COUNT_Pos)      /* (RTC_MODE0_SYNCBUSY) Counter Value Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_COMP0_Pos          _UINT32_(5)                                          /* (RTC_MODE0_SYNCBUSY) Compare 0 Value Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_COMP0_Msk          (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_COMP0_Pos)      /* (RTC_MODE0_SYNCBUSY) Compare 0 Value Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_COUNTSYNC_Pos      _UINT32_(15)                                         /* (RTC_MODE0_SYNCBUSY) COUNT Read Resynchronization Enable Synchronization Busy Position */
#define RTC_MODE0_SYNCBUSY_COUNTSYNC_Msk      (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_COUNTSYNC_Pos)  /* (RTC_MODE0_SYNCBUSY) COUNT Read Resynchronization Enable Synchronization Busy Mask */
...
#define RTC_MODE0_SYNCBUSY_COMP_Pos           _UINT32_(5)                                          /* (RTC_MODE0_SYNCBUSY Position) Compare x Value Synchronization Busy */
...
/* -------- RTC_MODE1_SYNCBUSY : (RTC Offset: 0x10) ( R/ 32) MODE1 Synchronization Busy -------- */
#define RTC_MODE1_SYNCBUSY_RESETVALUE         _UINT32_(0x00)                                       /*  (RTC_MODE1_SYNCBUSY) MODE1 Synchronization Busy  Reset Value */

#define RTC_MODE1_SYNCBUSY_SWRST_Pos          _UINT32_(0)                                          /* (RTC_MODE1_SYNCBUSY) Software Reset Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_SWRST_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_SWRST_Pos)      /* (RTC_MODE1_SYNCBUSY) Software Reset Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_ENABLE_Pos         _UINT32_(1)                                          /* (RTC_MODE1_SYNCBUSY) Enable Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_ENABLE_Msk         (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_ENABLE_Pos)     /* (RTC_MODE1_SYNCBUSY) Enable Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_FREQCORR_Pos       _UINT32_(2)                                          /* (RTC_MODE1_SYNCBUSY) Frequency Correction Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_FREQCORR_Msk       (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_FREQCORR_Pos)   /* (RTC_MODE1_SYNCBUSY) Frequency Correction Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_COUNT_Pos          _UINT32_(3)                                          /* (RTC_MODE1_SYNCBUSY) Counter Value Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_COUNT_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COUNT_Pos)      /* (RTC_MODE1_SYNCBUSY) Counter Value Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_PER_Pos            _UINT32_(4)                                          /* (RTC_MODE1_SYNCBUSY) Counter Period Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_PER_Msk            (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_PER_Pos)        /* (RTC_MODE1_SYNCBUSY) Counter Period Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_COMP0_Pos          _UINT32_(5)                                          /* (RTC_MODE1_SYNCBUSY) Compare 0 Value Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_COMP0_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COMP0_Pos)      /* (RTC_MODE1_SYNCBUSY) Compare 0 Value Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_COMP1_Pos          _UINT32_(6)                                          /* (RTC_MODE1_SYNCBUSY) Compare 1 Value Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_COMP1_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COMP1_Pos)      /* (RTC_MODE1_SYNCBUSY) Compare 1 Value Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_COUNTSYNC_Pos      _UINT32_(15)                                         /* (RTC_MODE1_SYNCBUSY) COUNT Read Resynchronization Enable Synchronization Busy Position */
#define RTC_MODE1_SYNCBUSY_COUNTSYNC_Msk      (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COUNTSYNC_Pos)  /* (RTC_MODE1_SYNCBUSY) COUNT Read Resynchronization Enable Synchronization Busy Mask */
...
#define RTC_MODE1_SYNCBUSY_COMP_Pos           _UINT32_(5)                                          /* (RTC_MODE1_SYNCBUSY Position) Compare x Value Synchronization Busy */
...
/* -------- RTC_MODE2_SYNCBUSY : (RTC Offset: 0x10) ( R/ 32) MODE2 Synchronization Busy -------- */
#define RTC_MODE2_SYNCBUSY_RESETVALUE         _UINT32_(0x00)                                       /*  (RTC_MODE2_SYNCBUSY) MODE2 Synchronization Busy  Reset Value */

#define RTC_MODE2_SYNCBUSY_SWRST_Pos          _UINT32_(0)                                          /* (RTC_MODE2_SYNCBUSY) Software Reset Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_SWRST_Msk          (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_SWRST_Pos)      /* (RTC_MODE2_SYNCBUSY) Software Reset Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_ENABLE_Pos         _UINT32_(1)                                          /* (RTC_MODE2_SYNCBUSY) Enable Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_ENABLE_Msk         (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_ENABLE_Pos)     /* (RTC_MODE2_SYNCBUSY) Enable Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_FREQCORR_Pos       _UINT32_(2)                                          /* (RTC_MODE2_SYNCBUSY) Frequency Correction Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_FREQCORR_Msk       (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_FREQCORR_Pos)   /* (RTC_MODE2_SYNCBUSY) Frequency Correction Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_CLOCK_Pos          _UINT32_(3)                                          /* (RTC_MODE2_SYNCBUSY) Clock Value Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_CLOCK_Msk          (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_CLOCK_Pos)      /* (RTC_MODE2_SYNCBUSY) Clock Value Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_ALARM0_Pos         _UINT32_(5)                                          /* (RTC_MODE2_SYNCBUSY) Alarm 0 Value Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_ALARM0_Msk         (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_ALARM0_Pos)     /* (RTC_MODE2_SYNCBUSY) Alarm 0 Value Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_MASK0_Pos          _UINT32_(11)                                         /* (RTC_MODE2_SYNCBUSY) Alarm 0 Mask Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_MASK0_Msk          (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_MASK0_Pos)      /* (RTC_MODE2_SYNCBUSY) Alarm 0 Mask Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_CLOCKSYNC_Pos      _UINT32_(15)                                         /* (RTC_MODE2_SYNCBUSY) CLOCK Read Resynchronization Enable Synchronization Busy Position */
#define RTC_MODE2_SYNCBUSY_CLOCKSYNC_Msk      (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_CLOCKSYNC_Pos)  /* (RTC_MODE2_SYNCBUSY) CLOCK Read Resynchronization Enable Synchronization Busy Mask */
...
#define RTC_MODE2_SYNCBUSY_ALARM_Pos          _UINT32_(5)                                          /* (RTC_MODE2_SYNCBUSY Position) Alarm x Value Synchronization Busy */
...
#define RTC_MODE2_SYNCBUSY_MASK_Pos           _UINT32_(11)                                         /* (RTC_MODE2_SYNCBUSY Position) Alarm x Mask Synchronization Busy */
...
#define   RTC_MODE2_CLOCK_MONTH_JAN_Val       _UINT32_(0x1)                                        /* (RTC_MODE2_CLOCK) January  */
#define   RTC_MODE2_CLOCK_MONTH_FEB_Val       _UINT32_(0x2)                                        /* (RTC_MODE2_CLOCK) February  */
#define   RTC_MODE2_CLOCK_MONTH_MAR_Val       _UINT32_(0x3)                                        /* (RTC_MODE2_CLOCK) March  */
#define   RTC_MODE2_CLOCK_MONTH_APR_Val       _UINT32_(0x4)                                        /* (RTC_MODE2_CLOCK) April  */
#define   RTC_MODE2_CLOCK_MONTH_MAY_Val       _UINT32_(0x5)                                        /* (RTC_MODE2_CLOCK) May  */
#define   RTC_MODE2_CLOCK_MONTH_JUN_Val       _UINT32_(0x6)                                        /* (RTC_MODE2_CLOCK) June  */
#define   RTC_MODE2_CLOCK_MONTH_JUL_Val       _UINT32_(0x7)                                        /* (RTC_MODE2_CLOCK) July  */
#define   RTC_MODE2_CLOCK_MONTH_AUG_Val       _UINT32_(0x8)                                        /* (RTC_MODE2_CLOCK) August  */
#define   RTC_MODE2_CLOCK_MONTH_SEP_Val       _UINT32_(0x9)                                        /* (RTC_MODE2_CLOCK) September  */
#define   RTC_MODE2_CLOCK_MONTH_OCT_Val       _UINT32_(0xA)                                        /* (RTC_MODE2_CLOCK) October  */
#define   RTC_MODE2_CLOCK_MONTH_NOV_Val       _UINT32_(0xB)                                        /* (RTC_MODE2_CLOCK) November  */
#define   RTC_MODE2_CLOCK_MONTH_DEC_Val       _UINT32_(0xC)                                        /* (RTC_MODE2_CLOCK) December  */
#define RTC_MODE2_CLOCK_MONTH_JAN             (RTC_MODE2_CLOCK_MONTH_JAN_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) January Position */
#define RTC_MODE2_CLOCK_MONTH_FEB             (RTC_MODE2_CLOCK_MONTH_FEB_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) February Position */
#define RTC_MODE2_CLOCK_MONTH_MAR             (RTC_MODE2_CLOCK_MONTH_MAR_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) March Position */
#define RTC_MODE2_CLOCK_MONTH_APR             (RTC_MODE2_CLOCK_MONTH_APR_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) April Position */
#define RTC_MODE2_CLOCK_MONTH_MAY             (RTC_MODE2_CLOCK_MONTH_MAY_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) May Position */
#define RTC_MODE2_CLOCK_MONTH_JUN             (RTC_MODE2_CLOCK_MONTH_JUN_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) June Position */
#define RTC_MODE2_CLOCK_MONTH_JUL             (RTC_MODE2_CLOCK_MONTH_JUL_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) July Position */
#define RTC_MODE2_CLOCK_MONTH_AUG             (RTC_MODE2_CLOCK_MONTH_AUG_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) August Position */
#define RTC_MODE2_CLOCK_MONTH_SEP             (RTC_MODE2_CLOCK_MONTH_SEP_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) September Position */
#define RTC_MODE2_CLOCK_MONTH_OCT             (RTC_MODE2_CLOCK_MONTH_OCT_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) October Position */
#define RTC_MODE2_CLOCK_MONTH_NOV             (RTC_MODE2_CLOCK_MONTH_NOV_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) November Position */
#define RTC_MODE2_CLOCK_MONTH_DEC             (RTC_MODE2_CLOCK_MONTH_DEC_Val << RTC_MODE2_CLOCK_MONTH_Pos) /* (RTC_MODE2_CLOCK) December Position */
...
#define RTC_MODE2_CLOCK_Msk                   _UINT32_(0xFFFE0FFF)                                 /* (RTC_MODE2_CLOCK) Register Mask  */

/* CLK12H mode */
#define RTC_MODE2_CLOCK_CLK12H_HOUR_Pos       _UINT32_(12)                                         /* (RTC_MODE2_CLOCK) Hour Position */
#define RTC_MODE2_CLOCK_CLK12H_HOUR_Msk       (_UINT32_(0xF) << RTC_MODE2_CLOCK_CLK12H_HOUR_Pos)   /* (RTC_MODE2_CLOCK) Hour Mask */
#define RTC_MODE2_CLOCK_CLK12H_HOUR(value)    (RTC_MODE2_CLOCK_CLK12H_HOUR_Msk & (_UINT32_(value) << RTC_MODE2_CLOCK_CLK12H_HOUR_Pos))
#define RTC_MODE2_CLOCK_CLK12H_INDICATOR_Pos  _UINT32_(16)                                         /* (RTC_MODE2_CLOCK) Meridiem Indicator Position */
#define RTC_MODE2_CLOCK_CLK12H_INDICATOR_Msk  (_UINT32_(0x1) << RTC_MODE2_CLOCK_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_CLOCK) Meridiem Indicator Mask */
#define RTC_MODE2_CLOCK_CLK12H_INDICATOR(value) (RTC_MODE2_CLOCK_CLK12H_INDICATOR_Msk & (_UINT32_(value) << RTC_MODE2_CLOCK_CLK12H_INDICATOR_Pos))
#define   RTC_MODE2_CLOCK_CLK12H_INDICATOR_AM_Val _UINT32_(0x0)                                        /* (RTC_MODE2_CLOCK) Before midday (AM)  */
#define   RTC_MODE2_CLOCK_CLK12H_INDICATOR_PM_Val _UINT32_(0x1)                                        /* (RTC_MODE2_CLOCK) After midday (PM)  */
#define RTC_MODE2_CLOCK_CLK12H_INDICATOR_AM   (RTC_MODE2_CLOCK_CLK12H_INDICATOR_AM_Val << RTC_MODE2_CLOCK_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_CLOCK) Before midday (AM) Position */
#define RTC_MODE2_CLOCK_CLK12H_INDICATOR_PM   (RTC_MODE2_CLOCK_CLK12H_INDICATOR_PM_Val << RTC_MODE2_CLOCK_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_CLOCK) After midday (PM) Position */
#define RTC_MODE2_CLOCK_CLK12H_Msk            _UINT32_(0x0001F000)                                 /* (RTC_MODE2_CLOCK_CLK12H) Register Mask  */

/* CLK24H mode */
#define RTC_MODE2_CLOCK_CLK24H_HOUR_Pos       _UINT32_(12)                                         /* (RTC_MODE2_CLOCK) Hour Position */
#define RTC_MODE2_CLOCK_CLK24H_HOUR_Msk       (_UINT32_(0x1F) << RTC_MODE2_CLOCK_CLK24H_HOUR_Pos)  /* (RTC_MODE2_CLOCK) Hour Mask */
#define RTC_MODE2_CLOCK_CLK24H_HOUR(value)    (RTC_MODE2_CLOCK_CLK24H_HOUR_Msk & (_UINT32_(value) << RTC_MODE2_CLOCK_CLK24H_HOUR_Pos))
#define RTC_MODE2_CLOCK_CLK24H_Msk            _UINT32_(0x0001F000)                                 /* (RTC_MODE2_CLOCK_CLK24H) Register Mask  */
...
#define RTC_MODE0_COMP_RESETVALUE             _UINT32_(0x00)                                       /*  (RTC_MODE0_COMP) MODE0 Compare # Value  Reset Value */
...
/* -------- RTC_MODE1_COMP : (RTC Offset: 0x20) (R/W 16) MODE1 Compare # Value -------- */
#define RTC_MODE1_COMP_RESETVALUE             _UINT16_(0x00)                                       /*  (RTC_MODE1_COMP) MODE1 Compare # Value  Reset Value */
...
/* -------- RTC_MODE2_ALARM0 : (RTC Offset: 0x20) (R/W 32) MODE2 Alarm 0 Value -------- */
#define RTC_MODE2_ALARM0_RESETVALUE           _UINT32_(0x00)                                       /*  (RTC_MODE2_ALARM0) MODE2 Alarm 0 Value  Reset Value */
...
#define   RTC_MODE2_ALARM0_MONTH_JAN_Val      _UINT32_(0x1)                                        /* (RTC_MODE2_ALARM0) January  */
#define   RTC_MODE2_ALARM0_MONTH_FEB_Val      _UINT32_(0x2)                                        /* (RTC_MODE2_ALARM0) February  */
#define   RTC_MODE2_ALARM0_MONTH_MAR_Val      _UINT32_(0x3)                                        /* (RTC_MODE2_ALARM0) March  */
#define   RTC_MODE2_ALARM0_MONTH_APR_Val      _UINT32_(0x4)                                        /* (RTC_MODE2_ALARM0) April  */
#define   RTC_MODE2_ALARM0_MONTH_MAY_Val      _UINT32_(0x5)                                        /* (RTC_MODE2_ALARM0) May  */
#define   RTC_MODE2_ALARM0_MONTH_JUN_Val      _UINT32_(0x6)                                        /* (RTC_MODE2_ALARM0) June  */
#define   RTC_MODE2_ALARM0_MONTH_JUL_Val      _UINT32_(0x7)                                        /* (RTC_MODE2_ALARM0) July  */
#define   RTC_MODE2_ALARM0_MONTH_AUG_Val      _UINT32_(0x8)                                        /* (RTC_MODE2_ALARM0) August  */
#define   RTC_MODE2_ALARM0_MONTH_SEP_Val      _UINT32_(0x9)                                        /* (RTC_MODE2_ALARM0) September  */
#define   RTC_MODE2_ALARM0_MONTH_OCT_Val      _UINT32_(0xA)                                        /* (RTC_MODE2_ALARM0) October  */
#define   RTC_MODE2_ALARM0_MONTH_NOV_Val      _UINT32_(0xB)                                        /* (RTC_MODE2_ALARM0) November  */
#define   RTC_MODE2_ALARM0_MONTH_DEC_Val      _UINT32_(0xC)                                        /* (RTC_MODE2_ALARM0) December  */
#define RTC_MODE2_ALARM0_MONTH_JAN            (RTC_MODE2_ALARM0_MONTH_JAN_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) January Position */
#define RTC_MODE2_ALARM0_MONTH_FEB            (RTC_MODE2_ALARM0_MONTH_FEB_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) February Position */
#define RTC_MODE2_ALARM0_MONTH_MAR            (RTC_MODE2_ALARM0_MONTH_MAR_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) March Position */
#define RTC_MODE2_ALARM0_MONTH_APR            (RTC_MODE2_ALARM0_MONTH_APR_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) April Position */
#define RTC_MODE2_ALARM0_MONTH_MAY            (RTC_MODE2_ALARM0_MONTH_MAY_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) May Position */
#define RTC_MODE2_ALARM0_MONTH_JUN            (RTC_MODE2_ALARM0_MONTH_JUN_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) June Position */
#define RTC_MODE2_ALARM0_MONTH_JUL            (RTC_MODE2_ALARM0_MONTH_JUL_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) July Position */
#define RTC_MODE2_ALARM0_MONTH_AUG            (RTC_MODE2_ALARM0_MONTH_AUG_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) August Position */
#define RTC_MODE2_ALARM0_MONTH_SEP            (RTC_MODE2_ALARM0_MONTH_SEP_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) September Position */
#define RTC_MODE2_ALARM0_MONTH_OCT            (RTC_MODE2_ALARM0_MONTH_OCT_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) October Position */
#define RTC_MODE2_ALARM0_MONTH_NOV            (RTC_MODE2_ALARM0_MONTH_NOV_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) November Position */
#define RTC_MODE2_ALARM0_MONTH_DEC            (RTC_MODE2_ALARM0_MONTH_DEC_Val << RTC_MODE2_ALARM0_MONTH_Pos) /* (RTC_MODE2_ALARM0) December Position */
...
#define RTC_MODE2_ALARM0_Msk                  _UINT32_(0xFFFE0FFF)                                 /* (RTC_MODE2_ALARM0) Register Mask  */

/* CLK12H mode */
#define RTC_MODE2_ALARM0_CLK12H_HOUR_Pos      _UINT32_(12)                                         /* (RTC_MODE2_ALARM0) Hour Position */
#define RTC_MODE2_ALARM0_CLK12H_HOUR_Msk      (_UINT32_(0xF) << RTC_MODE2_ALARM0_CLK12H_HOUR_Pos)  /* (RTC_MODE2_ALARM0) Hour Mask */
#define RTC_MODE2_ALARM0_CLK12H_HOUR(value)   (RTC_MODE2_ALARM0_CLK12H_HOUR_Msk & (_UINT32_(value) << RTC_MODE2_ALARM0_CLK12H_HOUR_Pos))
#define RTC_MODE2_ALARM0_CLK12H_INDICATOR_Pos _UINT32_(16)                                         /* (RTC_MODE2_ALARM0) Meridiem Indicator Position */
#define RTC_MODE2_ALARM0_CLK12H_INDICATOR_Msk (_UINT32_(0x1) << RTC_MODE2_ALARM0_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_ALARM0) Meridiem Indicator Mask */
#define RTC_MODE2_ALARM0_CLK12H_INDICATOR(value) (RTC_MODE2_ALARM0_CLK12H_INDICATOR_Msk & (_UINT32_(value) << RTC_MODE2_ALARM0_CLK12H_INDICATOR_Pos))
#define   RTC_MODE2_ALARM0_CLK12H_INDICATOR_AM_Val _UINT32_(0x0)                                        /* (RTC_MODE2_ALARM0) Before midday (AM)  */
#define   RTC_MODE2_ALARM0_CLK12H_INDICATOR_PM_Val _UINT32_(0x1)                                        /* (RTC_MODE2_ALARM0) After midday (PM)  */
#define RTC_MODE2_ALARM0_CLK12H_INDICATOR_AM  (RTC_MODE2_ALARM0_CLK12H_INDICATOR_AM_Val << RTC_MODE2_ALARM0_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_ALARM0) Before midday (AM) Position */
#define RTC_MODE2_ALARM0_CLK12H_INDICATOR_PM  (RTC_MODE2_ALARM0_CLK12H_INDICATOR_PM_Val << RTC_MODE2_ALARM0_CLK12H_INDICATOR_Pos) /* (RTC_MODE2_ALARM0) After midday (PM) Position */
#define RTC_MODE2_ALARM0_CLK12H_Msk           _UINT32_(0x0001F000)                                 /* (RTC_MODE2_ALARM0_CLK12H) Register Mask  */

/* CLK24H mode */
#define RTC_MODE2_ALARM0_CLK24H_HOUR_Pos      _UINT32_(12)                                         /* (RTC_MODE2_ALARM0) Hour Position */
#define RTC_MODE2_ALARM0_CLK24H_HOUR_Msk      (_UINT32_(0x1F) << RTC_MODE2_ALARM0_CLK24H_HOUR_Pos) /* (RTC_MODE2_ALARM0) Hour Mask */
#define RTC_MODE2_ALARM0_CLK24H_HOUR(value)   (RTC_MODE2_ALARM0_CLK24H_HOUR_Msk & (_UINT32_(value) << RTC_MODE2_ALARM0_CLK24H_HOUR_Pos))
#define RTC_MODE2_ALARM0_CLK24H_Msk           _UINT32_(0x0001F000)                                 /* (RTC_MODE2_ALARM0_CLK24H) Register Mask  */


/* -------- RTC_MODE2_MASK0 : (RTC Offset: 0x24) (R/W 8) MODE2 Alarm 0 Mask -------- */
#define RTC_MODE2_MASK0_RESETVALUE            _UINT8_(0x00)                                        /*  (RTC_MODE2_MASK0) MODE2 Alarm 0 Mask  Reset Value */
...
#define RTC_MODE0_SYNCBUSY_REG_OFST    _UINT32_(0x10)      /* (RTC_MODE0_SYNCBUSY) MODE0 Synchronization Busy Offset */
#define RTC_MODE1_SYNCBUSY_REG_OFST    _UINT32_(0x10)      /* (RTC_MODE1_SYNCBUSY) MODE1 Synchronization Busy Offset */
#define RTC_MODE2_SYNCBUSY_REG_OFST    _UINT32_(0x10)      /* (RTC_MODE2_SYNCBUSY) MODE2 Synchronization Busy Offset */
...
#define RTC_MODE0_COMP_REG_OFST        _UINT32_(0x20)      /* (RTC_MODE0_COMP) MODE0 Compare # Value Offset */
#define RTC_MODE1_COMP_REG_OFST        _UINT32_(0x20)      /* (RTC_MODE1_COMP) MODE1 Compare # Value Offset */
#define RTC_MODE1_COMP0_REG_OFST       _UINT32_(0x20)      /* (RTC_MODE1_COMP0) MODE1 Compare # Value Offset */
#define RTC_MODE1_COMP1_REG_OFST       _UINT32_(0x22)      /* (RTC_MODE1_COMP1) MODE1 Compare # Value Offset */
#define RTC_MODE2_ALARM0_REG_OFST      _UINT32_(0x20)      /* (RTC_MODE2_ALARM0) MODE2 Alarm 0 Value Offset */
#define RTC_MODE2_MASK0_REG_OFST       _UINT32_(0x24)      /* (RTC_MODE2_MASK0) MODE2 Alarm 0 Mask Offset */
...
{  /* Real-Time Counter */
  ...
  __I   uint32_t                       RTC_SYNCBUSY;       /* Offset: 0x10 (R/   32) MODE0 Synchronization Busy */
...
{  /* Real-Time Counter */
  ...
  __IO  uint8_t                        RTC_DBGCTRL;        /* Offset: 0x0E (R/W  8) Debug Control */
  __I   uint8_t                        Reserved2[0x01];
  __I   uint32_t                       RTC_SYNCBUSY;       /* Offset: 0x10 (R/   32) MODE1 Synchronization Busy */
  __IO  uint8_t                        RTC_FREQCORR;       /* Offset: 0x14 (R/W  8) Frequency Correction */
  __I   uint8_t                        Reserved3[0x03];
  ...
  __IO  uint16_t                       RTC_COMP[2];        /* Offset: 0x20 (R/W  16) MODE1 Compare # Value */
...
{  /* Real-Time Counter */
  ...
  __IO  uint8_t                        RTC_DBGCTRL;        /* Offset: 0x0E (R/W  8) Debug Control */
  __I   uint8_t                        Reserved2[0x01];
  __I   uint32_t                       RTC_SYNCBUSY;       /* Offset: 0x10 (R/   32) MODE2 Synchronization Busy */
  __IO  uint8_t                        RTC_FREQCORR;       /* Offset: 0x14 (R/W  8) Frequency Correction */
  __I   uint8_t                        Reserved3[0x03];
  __IO  uint32_t                       RTC_CLOCK;          /* Offset: 0x18 (R/W  32) MODE2 Clock Value */
  __I   uint8_t                        Reserved4[0x04];
  __IO  uint32_t                       RTC_ALARM0;         /* Offset: 0x20 (R/W  32) MODE2 Alarm 0 Value */
  __IO  uint8_t                        RTC_MASK0;          /* Offset: 0x24 (R/W  8) MODE2 Alarm 0 Mask */
} rtc_mode2_registers_t;

/* RTC hardware registers */
typedef union
{  /* Real-Time Counter */
       rtc_mode0_registers_t          MODE0;          /* 32-bit Counter Mode */
       rtc_mode1_registers_t          MODE1;          /* 16-bit Counter Mode */
       rtc_mode2_registers_t          MODE2;          /* Clock and Calendar Mode with Alarm */
} rtc_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CMPL10_RTC_COMPONENT_H_ */
