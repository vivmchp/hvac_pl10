...
#ifndef _PIC32CMPL10_WDT_COMPONENT_H_
#define _PIC32CMPL10_WDT_COMPONENT_H_
...
/* -------- WDT_CTRLA : (WDT Offset: 0x00) (R/W 8) Control A -------- */
...
/* -------- WDT_EWCTRL : (WDT Offset: 0x02) (R/W 8) Early Warning Control -------- */
...
#define WDT_SYNCBUSY_ALWAYSON_Pos             _UINT32_(3)                                          /* (WDT_SYNCBUSY) ALWAYSON Synchronization Busy Position */
#define WDT_SYNCBUSY_ALWAYSON_Msk             (_UINT32_(0x1) << WDT_SYNCBUSY_ALWAYSON_Pos)         /* (WDT_SYNCBUSY) ALWAYSON Synchronization Busy Mask */
...
#define WDT_CTRLA_REG_OFST             _UINT32_(0x00)      /* (WDT_CTRLA) Control A Offset */
#define WDT_CONFIG_REG_OFST            _UINT32_(0x01)      /* (WDT_CONFIG) Configuration Offset */
#define WDT_EWCTRL_REG_OFST            _UINT32_(0x02)      /* (WDT_EWCTRL) Early Warning Control Offset */
...
typedef struct
{  /* Watchdog Timer */
  __IO  uint8_t                        WDT_CTRLA;          /* Offset: 0x00 (R/W  8) Control A */
  __IO  uint8_t                        WDT_CONFIG;         /* Offset: 0x01 (R/W  8) Configuration */
  __IO  uint8_t                        WDT_EWCTRL;         /* Offset: 0x02 (R/W  8) Early Warning Control */
...
#endif /* _PIC32CMPL10_WDT_COMPONENT_H_ */
